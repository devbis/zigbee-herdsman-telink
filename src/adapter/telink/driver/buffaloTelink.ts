...
export interface BuffaloTelinkOptions extends BuffaloZclOptions {
    startIndex?: number;
}

class BuffaloTelink extends Buffalo {
    public write(type: ParameterType, value: any, options: BuffaloTelinkOptions): void {
        switch (type) {
    ...
    public read(type: ParameterType, options: BuffaloTelinkOptions): any {
        switch (type) {
        case ParameterType.UINT8: {
