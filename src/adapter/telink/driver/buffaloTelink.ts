...
export interface BuffaloTelinkOptions extends BuffaloTsType.Options {
    startIndex?: number;
}
...
class BuffaloTelink extends Buffalo {
    ...
    public read(type: string, options: BuffaloTelinkOptions): TsType.Value {
    ...
    public readIeeeAddr(): string {
        ...
        return BuffaloTelink.addressBufferToStringBE(value);
    }
